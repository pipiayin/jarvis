...
rm ailine.zip
rm aiBrain.zip
zip aiBrain.zip -r data/ dynamoKB.py jieba/ lambda_brain.py socialBrain.py basickb.csv requests/  pttChat.py basickb.csv wikiChat.py esKB.py elasticsearch/ urllib3 requests_aws4auth/ credentials esHealth.py esBible.py linecre.so
