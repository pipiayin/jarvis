...
zip aifbresponse.zip -r data/ dynamoKB.py   basickb.csv requests/  pttChat.py basickb.csv basickb_en.csv  esKB.py elasticsearch/ urllib3 requests_aws4auth/ credentials esHealth.py esBible.py awsconfig.py nocheckin.py linecre.so awsconfig.py credentials_ai nocheckin.py genericKB.py lambda_fbresponse.py  nltk_data/ socialEnBrain.py  wikiFinder.py textblob/ nltk/
