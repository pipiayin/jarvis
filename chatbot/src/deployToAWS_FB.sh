...
zip aifbresponse.zip -r data/ dynamoKB.py jieba/ lambda_ai.py socialBrain.py basickb.csv requests/  pttChat.py basickb.csv wikiChat.py esKB.py elasticsearch/ urllib3 requests_aws4auth/ credentials esHealth.py esBible.py awsconfig.py nocheckin.py linecre.so awsconfig.py credentials_ai nocheckin.py genericKB.py lambda_fbresponse.py 
