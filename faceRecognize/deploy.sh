...
zip facerecognize.zip -r lambda_facerecognize.py  requests/ 
...
aws --profile ailine lambda update-function-code --function-name facerecogniz --s3-bucket sandyai2 --s3-key facerecognize.zip
